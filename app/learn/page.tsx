...
const T = {
  en: {
    ...
    concepts: {
      ...
      sub:     "Six areas that make up the quantitative finance landscape. We'll cover all of them inside QuantTec.",
    },
    cta: {
  ...
  es: {
    ...
    concepts: {
      ...
      sub:     "Seis áreas que conforman el panorama de las finanzas cuantitativas. Las cubriremos todas dentro de QuantTec.",
    },
    cta: {
      ...
      <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/95 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-6">
          ...
          <nav className="hidden md:flex items-center gap-7">
            <Link href="/#pillars" className="text-xs font-display text-slate-500 hover:text-slate-900 transition-colors tracking-wide">{t.nav.about}</Link>
            <Link href="/#team" className="text-xs font-display text-slate-500 hover:text-slate-900 transition-colors tracking-wide">{t.nav.team}</Link>
          </nav>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <section className="pt-20 pb-16 lg:pt-28 lg:pb-20 border-b border-slate-100">
          <motion.p
            ...
            className="text-xs font-display font-semibold tracking-widest uppercase text-slate-400 mb-5"
          >
            {t.hero.eyebrow}
          </motion.p>
          <motion.h1
            ...
            className="font-display font-extrabold tracking-tight text-slate-900 mb-6"
          ...
          <motion.p
            ...
            className="font-display text-slate-500 text-lg leading-relaxed max-w-2xl"
          >
            {t.hero.sub}
          </motion.p>
        </section>
        ...
        <section className="py-16 lg:py-20 border-b border-slate-100">
          <div className="grid lg:grid-cols-[1fr,1.2fr] gap-12 lg:gap-20 items-start">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-xs font-display font-semibold tracking-widest uppercase text-slate-400 mb-4">// THE BASICS</p>
              <h2 className="font-display font-extrabold text-slate-900 tracking-tight mb-0" style={{ fontSize: "clamp(1.6rem,3vw,2.4rem)" }}>
                {t.what.heading}
              </h2>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <p className="font-display text-slate-600 leading-relaxed">{t.what.body1}</p>
              <p className="font-display text-slate-600 leading-relaxed">{t.what.body2}</p>
              <div className="mt-6 pl-5 border-l-2 border-tec-400">
                <p className="font-display text-slate-800 text-lg font-medium italic">{t.what.principle}</p>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20 border-b border-slate-100">
          <motion.div
            ...
            className="mb-10"
          >
            <p className="text-xs font-display font-semibold tracking-widest uppercase text-slate-400 mb-4">// SUBFIELDS</p>
            <h2 className="font-display font-extrabold text-slate-900 tracking-tight mb-3" style={{ fontSize: "clamp(1.6rem,3vw,2.4rem)" }}>
              {t.concepts.heading}
            </h2>
            <p className="font-display text-slate-500 max-w-xl">{t.concepts.sub}</p>
          </motion.div>
            ...
            {CONCEPTS.map((c, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-display text-sm font-semibold text-slate-900 mb-2">{label}</h3>
                  <p className="font-display text-xs text-slate-500 leading-relaxed">{sub}</p>
                </motion.div>
              );
            })}
          </div>
        ...
        <section className="py-16 lg:py-24 border-b border-slate-100">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <p className="text-xs font-display font-semibold tracking-widest uppercase text-slate-400 mb-4">{t.simons.eyebrow}</p>
            <h2 className="font-display font-extrabold text-slate-900 tracking-tight" style={{ fontSize: "clamp(1.8rem,4vw,3rem)" }}>
              {t.simons.name}
            </h2>
          ...
          >
            <blockquote
              className="font-display font-medium text-slate-800 leading-[1.5] mb-3"
          ...
          >
            {t.simons.stats.map(s => (
              <div key={s.val} className="bg-white px-6 py-5">
                ...
                <div className="text-xs font-display text-slate-500 leading-snug">{s.lbl}</div>
              </div>
            ))}
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-14">
            <motion.div
              ...
              className="space-y-4"
            >
              <p className="font-display text-slate-600 leading-relaxed">{t.simons.bio1}</p>
              <p className="font-display text-slate-600 leading-relaxed">{t.simons.bio2}</p>
              <p className="font-display text-slate-600 leading-relaxed">{t.simons.bio3}</p>
            </motion.div>
              ...
              <div className="space-y-5">
                {t.simons.principles.map((p, i) => (
                  <div key={i} className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-display text-sm font-semibold text-slate-900 mb-1.5">{p.title}</h4>
                      <p className="font-display text-sm text-slate-500 leading-relaxed">{p.body}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <section className="py-16 lg:py-20 border-b border-slate-100">
          ...
          >
            ...
            <p className="font-display text-slate-500 max-w-xl">{t.books.sub}</p>
          </motion.div>
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-100">
                    {tierBooks.map((book, j) => (
                      ...
                      >
                        ...
                        <h3 className="font-display text-sm font-bold text-slate-900 leading-snug mb-1">
                          {book.title}
                        </h3>
                        <p className="text-xs font-mono text-slate-400 mb-3">{book.author}</p>
                        <p className="font-display text-xs text-slate-500 leading-relaxed">
        ...
        <section className="py-16 lg:py-20 text-center max-w-2xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-display font-bold text-slate-900 mb-4" style={{ fontSize: "clamp(1.6rem,3vw,2.2rem)" }}>
              {t.cta.heading}
            </h2>
            <p className="font-display text-slate-500 mb-8 leading-relaxed">{t.cta.sub}</p>
            <Link
              href="/apply"
